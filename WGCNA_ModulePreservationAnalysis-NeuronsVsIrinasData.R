...
voineagu <- read_delim("combined_network_KME_voineagu2.csv", 
                       ";", escape_double = FALSE, trim_ws = TRUE)
...
larquivos<-list.files("data_comparison/irinasExprData",full.names=TRUE)
...
#load(file="modulePreservationNeuronVoineagu.RData")
